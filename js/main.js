function imc() {
  ...
  let imc = Math.round(num1 / (num2 **2));
  ...
  if (isNaN(num1) || isNaN(num2)) {
    ...
    document.getElementById(
      "resultado1"
    ).innerHTML = `<div class='alert alert-warning' role='alert'> <p>Usted Tiene Bajo Peso, IMC=${imc}</p><img src='img/delgado.png' alt=''></div>`;
  } else if (imc >= 19 && imc <= 24.9) {
    document.getElementById(
      "resultado1"
    ).innerHTML = `<div class='alert alert-success' role='alert'> <p>Usted Tiene Un Peso Normal, IMC=${imc}</p><img src='img/pesonormal.png' alt=''></div>`;
  } else if (imc >= 25 && imc <= 29.9) {
    document.getElementById(
      "resultado1"
    ).innerHTML = `<div class='alert alert-danger' role='alert'> <p>Usted Tiene Sobre peso, IMC=${imc}</p><img src='img/gordo.png' alt=''></div>`;
  } else if (imc >= 30 && imc <= 34.9) {
    document.getElementById(
      "resultado1"
    ).innerHTML = `<div class='alert alert-danger' role='alert'> <p>Usted Tiene Obesidad Tipo 1, IMC=${imc}</p><img src='img/gordo.png' alt=''></div>`;
  } else if (imc >= 35 && imc <= 39.9) {
    document.getElementById(
      "resultado1"
    ).innerHTML = `<div class='alert alert-danger' role='alert'> <p>Usted Tiene Obesidad Tipo 2, IMC=${imc}</p><img src='img/gordo.png' alt=''></div>`;
  } else if (imc >= 40 && imc <= 44.9) {
    document.getElementById(
      "resultado1"
    ).innerHTML = `<div class='alert alert-danger' role='alert'> <p>Usted Tiene Obesidad Tipo 3, IMC=${imc}</p><img src='img/gordo.png' alt=''></div>`;
  } else if (imc >= 50) {
    document.getElementById(
      "resultado1"
...
function lospisos() {
  ...
  if (zapatos < 10) {
    document.getElementById(
      "resultado4"
    ).innerHTML = `<div class='alert alert-warning' role='alert'> <p>No tuvo ninguno Descuento!</p><img src='img/descuentozapatos.png' alt=''></div>`;
  } else if (zapatos >= 10 && zapatos <= 20) {
    descuento = precio * zapatos * 0.1;
    document.getElementById(
      "resultado4"
    ).innerHTML = `<div class='alert alert-success' role='alert'> <p>Usted compro: ${zapatos} zapatos entonces el total es ${
      precio * zapatos
