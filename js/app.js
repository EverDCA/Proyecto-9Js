    ...
    if (sexo === "Masculino") {
      if (imc <= 18) {
        ...
        document.getElementById(
          "resultado"
        ).innerHTML = `<div class='alert alert-warning' role='warning'>Tienes: ${edad} años <br> Tu sexo es: ${sexo} <br> Tienes Una estatura de ${estatura} Cm <br> Su Peso Actual es de: ${peso}kg <br> <span class="badge text-bg-success">Su peso ideal es de ${pesoideal} Kg</span><br><span class="badge text-bg-warning">Usted Tiene: Poco Peso  Su imc es de ${imc}</span><img src='img/delgado.png' alt=''><br> <span class="badge text-bg-warning">Deberia Perder: ${lossweigth}kg </span></div>`;
      } else if (imc >= 19 && imc <= 24.9) {
        pesoideal = estatura - 100 - (estatura - 150) / 4;
        lossweigth = peso - pesoideal;
        document.getElementById(
          "resultado"
        ).innerHTML = `<div class='alert alert-success' role='alert'>Tienes: ${edad} años <br> Tu sexo es: ${sexo} <br> Tienes Una estatura de ${estatura} Cm <br> Su Peso Actual es de: ${peso}kg <br> <span class="badge text-bg-success">Su peso ideal es de ${pesoideal} Kg</span><br><span class="badge text-bg-success">Usted Tiene: Un peso Normal  su imc es de ${imc}</span><img src='img/pesonormal.png' alt=''><br> <span class="badge text-bg-warning">Deberia Perder: ${lossweigth}kg </span></div>`;
      } else if (imc >= 25 && imc <= 29.9) {
        pesoideal = estatura - 100 - (estatura - 150) / 4;
        lossweigth = peso - pesoideal;
        document.getElementById(
          "resultado"
        ).innerHTML = `<div class='alert alert-danger' role='alert'>Tienes: ${edad} años <br> Tu sexo es: ${sexo} <br> Tienes Una estatura de ${estatura} Cm <br> Su Peso Actual es de: ${peso}kg <br> <span class="badge text-bg-success">Su peso ideal es de ${pesoideal} Kg</span><br><span class="badge text-bg-danger">Usted Tiene: Sobre peso Su imc es de ${imc}</span><img src='img/gordo.png' alt=''> <br> <span class="badge text-bg-warning">Deberia Perder: ${lossweigth}kg </span></div>`;
      } else if (imc >= 30 && imc <= 34.9) {
        pesoideal = estatura - 100 - (estatura - 150) / 4;
        lossweigth = peso - pesoideal;
        document.getElementById(
          "resultado"
        ).innerHTML = `<div class='alert alert-danger' role='alert'>Tienes: ${edad} años <br> Tu sexo es: ${sexo} <br> Tienes Una estatura de ${estatura} Cm <br> Su Peso Actual es de: ${peso}kg <br> <span class="badge text-bg-success">Su peso ideal es de ${pesoideal} Kg</span><br><span class="badge text-bg-danger">Usted Tiene: Obesidad 1 Su IMC es de ${imc}</span><img src='img/gordo.png' alt=''> <br> <span class="badge text-bg-danger">Deberia Perder: ${lossweigth}kg </span></div>`;
      } else if (imc >= 35 && imc <= 39.9) {
        pesoideal = estatura - 100 - (estatura - 150) / 4;
        lossweigth = peso - pesoideal;
        document.getElementById(
          "resultado"
        ).innerHTML = `<div class='alert alert-danger' role='alert'>Tienes: ${edad} años <br> Tu sexo es: ${sexo} <br> Tienes Una estatura de ${estatura} Cm <br> Su Peso Actual es de: ${peso}kg <br> <span class="badge text-bg-success">Su peso ideal es de ${pesoideal} Kg</span><br><span class="badge text-bg-danger">Usted Tiene: Obesidad 2 Su Su IMC es de ${imc}</span><img src='img/gordo.png' alt=''> <br> <span class="badge text-bg-warning">Deberia Perder: ${lossweigth}kg </span></div>`;
      } else if (imc >= 40 && imc <= 44.9) {
        pesoideal = estatura - 100 - (estatura - 150) / 4;
        lossweigth = peso - pesoideal;
        document.getElementById(
          "resultado"
        ).innerHTML = `<div class='alert alert-danger' role='alert'>Tienes: ${edad} años <br> Tu sexo es: ${sexo} <br> Tienes Una estatura de ${estatura} Cm <br> Su Peso Actual es de: ${peso}kg <br> <span class="badge text-bg-success">Su peso ideal es de ${pesoideal} Kg</span><br><span class="badge text-bg-danger">Usted Tiene: Obesidad 3 Su IMC es de ${imc}</span><img src='img/gordo.png' alt=''> <br> <span class="badge text-bg-warning">Deberia Perder: ${lossweigth}kg </span></div>`;
      } else if (imc >= 50) {
        pesoideal = estatura - 100 - (estatura - 150) / 4;
        lossweigth = peso - pesoideal;
        document.getElementById(
          "resultado"
        ).innerHTML = `<div class='alert alert-danger' role='alert'>Tienes: ${edad} años <br> Tu sexo es: ${sexo} <br> Tienes Una estatura de ${estatura} Cm <br> Su Peso Actual es de: ${peso}kg <br> <span class="badge text-bg-success">Su peso ideal es de ${pesoideal} Kg</span><br><span class="badge text-bg-danger">Usted Tiene: Obesidad 4 Su IMC es de ${imc}</span><img src='img/gordo.png' alt=''> <br> <span class="badge text-bg-warning">Deberia Perder: ${lossweigth}kg </span></div>`;
      }
